...
@xvm.export('enemiesAliveRatingRatio', deterministic=False)
def enemiesAliveRatingRatio():
    if allies_wn8 != 0 and enemies_wn8 != 0:
...
@xvm.export('c_enemiesAliveRatingRatio', deterministic=False)
def c_enemiesAliveRatingRatio():
    if allies_wn8 != 0 and enemies_wn8 != 0:
        if allies_wn8 > enemies_wn8:
            x = float(50 - (1.0 - enemies_wn8 / allies_wn8) * 50)
            if x > 64.5:
